package Frontend.controllers.chat;
...
public class ServerController extends Application implements Initializable {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(ServerController.class.getResource("/run/project_ms2/Frontend/pages/chat/ServerChat.fxml"));
